...
Integrates all components: simplified vector store, document parsing, web scraping, and LLM providers
"""
...
class AICustomerService:
    ...
    def __init__(self, config: Optional[Dict] = None):
        ...
        self.vector_store = VectorStoreService(
            persist_directory=self.config.get("vector_store_dir", "./vector_store_data")
        )
    ...
    def add_document_to_knowledge_base(self, knowledge_base_id: str, file_path: str, metadata: Optional[Dict] = None) -> Dict:
        ...
        try:
            ...
            # Save parsed content to a temporary file for the vector store
            temp_file_path = f"./temp_parsed_{knowledge_base_id}_{hash(file_path)}.txt"
